...
void Main_PLL_Setup ( void )
{
  ...
  LPC_SYSCON->SYSPLLCLKUEN = 0x01;		            // 触发的方式更新
...
#if MAIN_PLL_SETUP	   // 设置系统的主时钟 = 12000000UL *（3+1） 48MHZ
...
//#endif
  ...
  /* bit 0 default is crystal bypass,  默认为0，是选择外部的时钟作为系统的时钟源，默认的时钟源12M
  bit1 0=0~20Mhz crystal input, 1=15~50Mhz crystal input. */
  LPC_SYSCON->SYSOSCCTRL = 0x00;

  /* main system OSC run is cleared, bit 5 in PDRUNCFG register   开启主时钟的电源 */
