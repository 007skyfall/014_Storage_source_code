...
#define  Task_Uart_PRIO	     	OS_LOWEST_PRIO-2
...
OS_STK  Task_Uart_STK[Task_Uart_SS];
...
int main(void)
{
  ...
  OSTaskCreate(Task_Led,(void *)0,&Task_Led_STK[Task_Led_SS-1],Task_Led_PRIO);
 ...
 */
  OSTaskCreateExt(Task_Seg7Led,
	              ...
	              OS_TASK_OPT_STK_CHK + OS_TASK_OPT_STK_CLR);
/* uart task*/
 OSTaskCreateExt(Task_Uart,
  			      (void *)0, 
                  &Task_Uart_STK[Task_Uart_SS-1], 
				  Task_Uart_PRIO, 
	              Task_Uart_PRIO, 
				  &Task_Uart_STK[0], 
				  Task_Uart_SS, 
