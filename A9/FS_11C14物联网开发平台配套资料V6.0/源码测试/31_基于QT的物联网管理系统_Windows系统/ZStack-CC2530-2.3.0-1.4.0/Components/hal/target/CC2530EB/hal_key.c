...
//K2 is at P1.3
#define HAL_KEY2_DIR  P1DIR
#define HAL_KEY2_SEL  P1SEL
#define HAL_KEY2_PORT P1
#define HAL_KEY2_BIT  BV(3)
#define HAL_KEY2_EDGEBIT BV(1)
#define HAL_KEY2_EDGE HAL_KEY_FALLING_EDGE

#define HAL_KEY2_IEN IEN2
#define HAL_KEY2_IENBIT BV(4)
#define HAL_KEY2_ICTL P1IEN
#define HAL_KEY2_ICTLBIT BV(3)
#define HAL_KEY2_PXIFG P1IFG
...
void HalKeyInit( void )
{
  ...
  HAL_KEY2_SEL &= ~(HAL_KEY2_BIT);
  HAL_KEY2_DIR &= ~(HAL_KEY2_BIT);
...
void HalKeyConfig (bool interruptEnable, halKeyCBack_t cback)
{
  ...
  if (Hal_KeyIntEnable)
  {
    ...
    PICTL &= ~(HAL_KEY2_EDGEBIT); 
    /* For falling edge, the bit must be set. */
  #if (HAL_KEY_SW_6_EDGE == HAL_KEY_FALLING_EDGE)
    PICTL |= HAL_KEY_SW_6_EDGEBIT;
  #endif
    
#if (HAL_KEY2_EDGE == HAL_KEY2_FALLING_EDGE)
    PICTL |= HAL_KEY2_EDGEBIT;
#endif
...
void halProcessKeyInterrupt (void)
{
  ...
  if(HAL_KEY2_PXIFG & HAL_KEY2_BIT)
  {
    HAL_KEY2_PXIFG = ~(HAL_KEY2_BIT);// add by jacky
    valid = TRUE;
  }
 ...
 * @return
 **************************************************************************************************/
HAL_ISR_FUNCTION( halKeyPort1Isr, P1INT_VECTOR )//add by jacky
{
  if(HAL_KEY2_PXIFG & HAL_KEY2_BIT)
  {
    halProcessKeyInterrupt();
