...
void InitBoard( uint8 level )
{
  ...
  else  // !OB_COLD
  {
    ...
    //OnboardKeyIntEnable = HAL_KEY_INTERRUPT_DISABLE;  //modify by jacky
    OnboardKeyIntEnable = HAL_KEY_INTERRUPT_ENABLE; //enable the interrupt
