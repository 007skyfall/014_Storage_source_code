...
#define OS_LOWEST_PRIO          252u   /* Defines the lowest priority that can be assigned ...         */
...
#define OS_EVENT_NAME_SIZE       32u   /* Determine the size of the name of a Sem, Mutex, Mbox or Q    */
#define OS_FLAG_NAME_SIZE        32u   /*     Determine the size of the name of an event flag group    */
#define OS_MEM_NAME_SIZE         32u   /*     Determine the size of a memory partition name            */
#define OS_TASK_NAME_SIZE        32u   /*     Determine the size of a task name                        */
#define OS_TMR_CFG_NAME_SIZE     32u   /*     Determine the size of a timer name                       */
