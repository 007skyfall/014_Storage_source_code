...
* Description    : RFID Functions test.
* Input          : None
* Output         : None
* Return         : None
*******************************************************************************/
...
/*******************************************************************************
* Function Name  : RFID_Read_Type
* Description    : RFID Read Card Type.
* Input          : None
* Output         : None
* Return         : None
*******************************************************************************/
void RFID_Read_Type(void)
{
  uint16_t	x, y;
  uint8_t	rbuf[36], chksum;
  char		buf[8];
  ...
  OLED_ClearScreen();
  OLED_DisStrLine(0, 0, "Read Card Type");
  ...
  while(1)
  {
    ...
    { 
      ...
      j = RFID_Operate((uint8_t *)RFID_READ_TYPE_19, rbuf);
	  
      printf("\r\n");
	  //for(i=0, x=0, y=1; i<j; i++)	
      for(i=2, x=0, y=1; (j>=5)&&(i<(j-1)); i++)	  
      {
		if(x <= 108)
		{
		  snprintf(buf, 4, "%02X ", rbuf[i]);
		  OLED_DisChar(2-1 + y, x, 0, buf[0]);
          x += 6;
          OLED_DisChar(2-1 + y, x, 0, buf[1]);
          x += 6;
          OLED_DisChar(2-1 + y, x, 0, buf[2]);
          x += 6;
        }
		else
		{
...
/*******************************************************************************
* Function Name  : RFID_Read_Card
* Description    : RFID Read Card Number.
* Input          : None
* Output         : None
* Return         : None
*******************************************************************************/
void RFID_Read_Card(void)
{
  ...
  OLED_ClearScreen();
  OLED_DisStrLine(0, 0, "Read Card Number");
  ...
  while(1)
  {
    ...
    { 
      ...
      j = RFID_Operate((uint8_t *)RFID_READ_CARD_20, rbuf);
	  
      printf("\r\n");
	  //for(i=0, x=0, y=1; i<j; i++)	
      for(i=2, x=0, y=1; (j>=7)&&(i<(j-1)); i++)	  
      {
		if(x <= 108)
		{
		  snprintf(buf, 4, "%02X ", rbuf[i]);
...
/*******************************************************************************
* Function Name  : RFID_Read_DataBlock
* Description    : RFID Read Data Block.
* Input          : None
* Output         : None
* Return         : None
*******************************************************************************/
void RFID_Read_DataBlock(void)
{
  uint16_t	x, y;
  uint8_t	rbuf[36], chksum;
  char		buf[8];
  ...
  OLED_ClearScreen();
  OLED_DisStrLine(0, 0, "Read Data Block");
...
/*******************************************************************************
* Function Name  : RFID_Write_DataBlock
* Description    : RFID Write Data Block.
* Input          : None
* Output         : None
* Return         : None
*******************************************************************************/
void RFID_Write_DataBlock(void)
{
  uint16_t	x, y;
  uint8_t	rbuf[36], chksum;
  char		buf[8];
  ...
  OLED_ClearScreen();
  OLED_DisStrLine(0, 0, "Write Data Block");
  OLED_DisStrLine(1, 0, "Press Sel Key");

  GPIOSetDir(PORT2, 8, 0);
  
  while(1)
  {
	if((!GPIOGetValue(PORT2, 8)) && (KEY_Read()==KEY_SEL))
    { 
	   	printf("\r\nRFID Write");		    
		j = RFID_Operate((uint8_t *)RFID_WRITE_DATA_BLOCK_22, rbuf);
