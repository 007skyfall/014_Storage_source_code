...
extern uint8_t A[6][128];
extern uint8_t B[6][128];

uint8_t time[17] = {5,7,9,12,13,15,18,20,24,27,31,38,40,49,63,75,80};
uint8_t time1[14]= {5,9,13,16,23,27,32,40,45,50,57,63,68,80};
uint8_t time2[11]= {5,9,16,25,32,45,50,62,69,75,80};
uint8_t time3[7] = {5,16,32,57,62,70,80};
uint8_t time4[4] = {5,32,60,80};
uint8_t time5[2] = {20,80};
//-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
//  Delay Time
//-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
...
//   
//-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
void Full_RAM(unsigned char Data)
{
	unsigned char i,j;
...
void ball(void)
{
	...
	Write_Command(16);			//   Default => 0x00 (Top Fixed Area)
	Write_Command(48);			//   Default => 0x40 (Vertical Scroll Area)
