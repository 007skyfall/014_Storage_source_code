...
const unsigned char Ascii_1[242][5]={		// Refer to "Times New Roman" Font Database...
									//   Basic Characters
...
void oled_test(void)
{
	const unsigned char Name[]={53,78,73,86,73,83,73,79,78,0};
								// Univision
	const unsigned char Tel[]={11,24,24,22,13,19,23,13,21,24,22,21,24,22,0};
								// +886-37-586586
	...
	while(1)
	{
		...
		Show_String(1,(unsigned char *)&Tel,0x04,XLevel+0x16);
		Delay(10);
		Fill_RAM(0x00);			// Clear Screen
	}
}
